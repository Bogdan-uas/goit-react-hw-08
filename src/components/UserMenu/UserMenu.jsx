...
return (
    ...
    <button
        ...
        disabled={isAnyModalOpen || isEditingGlobal}
    >
    ...
    {isLogoutModalOpen && (
        <div className={css.logout_modal}>
            ...
            <button className={css.cancel_button} onClick={cancelLogout}>Cancel</button>
            <button className={css.confirm_button} onClick={confirmLogout}>Confirm</button>
        </div>
        </div>
    )}
    </div>
